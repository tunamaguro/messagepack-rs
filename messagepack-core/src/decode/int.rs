...
impl<'de, 'a> Decode<'de, 'a> for u128 {
    type Value = Self;
...
impl<'de, 'a> Decode<'de, 'a> for i128 {
    type Value = Self;
...
impl<'de, 'a> Decode<'de, 'a> for usize {
    type Value = Self;
...
impl<'de, 'a> Decode<'de, 'a> for isize {
    type Value = Self;
